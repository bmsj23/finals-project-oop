...
public:
    Customer(string nm, string uname, string mail, string contact, string pass)
        : User(nm, uname, mail, contact, pass, false), ticketCount(0), counter(1) {}
    ...
    void sortMoviesMenu()
    {
        ...
        do
        {
            ...
            cout << endl
                 << "Movies sorted successfully:" << endl;
    ...
    void browseMovies()
    {
        ...
        for (int locationIndex = 0; locationIndex < 3; locationIndex++)
        {
            ...
            cout << endl
                 << (movie + 1) << ". Movie Name: " << movies[movie][0] << endl;
    ...
    int movieIndex = -1;
    for (int i = 0; i < 5; i++)  // Assuming 5 movies in the array
    {
    ...
    displaySeats(movieIndex, locationIndex, dateIndex, timeIndex);
        ...
        { // e-Wallet Payment
            ...
            cin >> phoneNumber;
            cout << endl
                 << "Processing " << ewalletName << " payment..." << endl;
            break;
        }
        }
    ...
    void purchaseTickets()
    {
        ...
        do
        {
            ...
            {
                cout << endl
                     << "Enter the number of the movie you want to watch (1-" << movieCount << "): ";
                if (!(cin >> movieChoice))
                {
                    cin.clear();
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
            ...
            { // checkout current ticket
                ...
                cout << endl
                     << "Proceeding to checkout for the current booking:" << endl;
